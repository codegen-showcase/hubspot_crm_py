...
from hubspot_crm_py.resources.meetings.batch import AsyncBatchClient, BatchClient
...
class MeetingsClient:
    ...
    def delete(
        ...
        *,
        ...
        Examples:
        ```py
        client.meetings.delete(meeting_id="string")
        ```
        """
    ...
    def get(
        ...
        *,
        ...
        Examples:
        ```py
        client.meetings.get(meeting_id="string")
        ```
        """
        _query: QueryParams = {}
        if not isinstance(archived, type_utils.NotGiven):
    ...
    def patch(
        ...
        *,
        ...
        Examples:
        ```py
        client.meetings.patch(meeting_id="string", properties={})
        ```
        """
        _query: QueryParams = {}
        if not isinstance(id_property, type_utils.NotGiven):
...
class AsyncMeetingsClient:
    ...
    async def delete(
        ...
        *,
        ...
        Examples:
        ```py
        await client.meetings.delete(meeting_id="string")
        ```
        """
    ...
    async def get(
        ...
        *,
        ...
        Examples:
        ```py
        await client.meetings.get(meeting_id="string")
        ```
        """
        _query: QueryParams = {}
        if not isinstance(archived, type_utils.NotGiven):
    ...
    async def patch(
        ...
        *,
        ...
        Examples:
        ```py
        await client.meetings.patch(meeting_id="string", properties={})
        ```
        """
        _query: QueryParams = {}
        if not isinstance(id_property, type_utils.NotGiven):
