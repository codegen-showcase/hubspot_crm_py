...
from hubspot_crm_py.resources.contacts.crm.v3.objects.contacts.batch import (
    AsyncBatchClient,
    BatchClient,
)
from hubspot_crm_py.resources.contacts.crm.v3.objects.contacts.gdpr_delete import (
    AsyncGdprDeleteClient,
    GdprDeleteClient,
)
from hubspot_crm_py.resources.contacts.crm.v3.objects.contacts.merge import (
    AsyncMergeClient,
    MergeClient,
)
from hubspot_crm_py.resources.contacts.crm.v3.objects.contacts.search import (
    AsyncSearchClient,
    SearchClient,
)
...
class ContactsClient:
    def __init__(self, *, base_client: SyncBaseClient):
        ...
        self.gdpr_delete = GdprDeleteClient(base_client=self._base_client)
        self.merge = MergeClient(base_client=self._base_client)
    ...
    def delete(
        ...
        *,
        ...
        Examples:
        ```py
        client.contacts.crm.v3.objects.contacts.delete(contact_id="string")
        ```
        """
    ...
    def list(
        ...
        *,
        ...
        Examples:
        ```py
        client.contacts.crm.v3.objects.contacts.list()
        ```
        """
        _query: QueryParams = {}
    ...
    def get(
        ...
        *,
        ...
        Examples:
        ```py
        client.contacts.crm.v3.objects.contacts.get(contact_id="string")
        ```
        """
        _query: QueryParams = {}
        if not isinstance(archived, type_utils.NotGiven):
    ...
    def patch(
        ...
        *,
        ...
        Examples:
        ```py
        client.contacts.crm.v3.objects.contacts.patch(
    ...
    def create(
        ...
        *,
        ...
        Examples:
        ```py
        client.contacts.crm.v3.objects.contacts.create(
            properties={},
            associations=[
                {
                    "to": {"id": "101"},
...
class AsyncContactsClient:
    def __init__(self, *, base_client: AsyncBaseClient):
        ...
        self.gdpr_delete = AsyncGdprDeleteClient(base_client=self._base_client)
        self.merge = AsyncMergeClient(base_client=self._base_client)
    ...
    async def delete(
        ...
        *,
        ...
        Examples:
        ```py
        await client.contacts.crm.v3.objects.contacts.delete(contact_id="string")
        ```
        """
    ...
    async def list(
        ...
        *,
        ...
        Examples:
        ```py
        await client.contacts.crm.v3.objects.contacts.list()
        ```
        """
        _query: QueryParams = {}
        if not isinstance(after, type_utils.NotGiven):
    ...
    async def get(
        ...
        *,
        ...
        Examples:
        ```py
        await client.contacts.crm.v3.objects.contacts.get(contact_id="string")
        ```
        """
        _query: QueryParams = {}
        if not isinstance(archived, type_utils.NotGiven):
    ...
    async def patch(
        ...
        *,
        ...
        Examples:
        ```py
        await client.contacts.crm.v3.objects.contacts.patch(
            contact_id="string", properties={}
        )
        ```
        """
    ...
    async def create(
        ...
        *,
        ...
        Examples:
        ```py
        await client.contacts.crm.v3.objects.contacts.create(
            properties={},
            associations=[
                {
                    "to": {"id": "101"},
