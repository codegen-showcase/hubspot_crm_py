...
def test_create_201_success_default():
    ...
    response = client.contacts.crm.v3.objects.contacts.create(
        properties={},
        associations=[
            {
                "to": {"id": "101"},
...
async def test_await_create_201_success_default():
    ...
    response = await client.contacts.crm.v3.objects.contacts.create(
        properties={},
        associations=[
            {
                "to": {"id": "101"},
...
def test_patch_200_success_default():
    ...
    response = client.contacts.crm.v3.objects.contacts.patch(
...
async def test_await_patch_200_success_default():
    ...
    response = await client.contacts.crm.v3.objects.contacts.patch(
        contact_id="string", properties={}
    )
    try:
        pydantic.TypeAdapter(models.SimplePublicObject).validate_python(response)
...
def test_get_200_generated_success():
    ...
    response = client.contacts.crm.v3.objects.contacts.get(contact_id="string")
    try:
...
async def test_await_get_200_generated_success():
    ...
    response = await client.contacts.crm.v3.objects.contacts.get(contact_id="string")
    try:
        pydantic.TypeAdapter(models.SimplePublicObjectWithAssociations).validate_python(
            response
        )
...
def test_list_200_generated_success():
    ...
    response = client.contacts.crm.v3.objects.contacts.list()
    try:
...
async def test_await_list_200_generated_success():
    ...
    response = await client.contacts.crm.v3.objects.contacts.list()
    try:
        pydantic.TypeAdapter(
            models.CollectionResponseSimplePublicObjectWithAssociationsForwardPaging
        ).validate_python(response)
...
def test_delete_204_generated_success():
    ...
    response = client.contacts.crm.v3.objects.contacts.delete(contact_id="string")
...
async def test_await_delete_204_generated_success():
    ...
    response = await client.contacts.crm.v3.objects.contacts.delete(contact_id="string")
    assert response is None
