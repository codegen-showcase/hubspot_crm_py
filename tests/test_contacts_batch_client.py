...
def test_upsert_200_success_default():
    """Tests a POST request to the /crm/v3/objects/contacts/batch/upsert endpoint.
    ...
    response = client.contacts.batch.upsert(inputs=[{"id": "string", "properties": {}}])
    try:
...
async def test_await_upsert_200_success_default():
    ...
    response = await client.contacts.batch.upsert(
...
def test_update_200_success_default():
    ...
    response = client.contacts.batch.update(inputs=[{"id": "1", "properties": {}}])
    try:
...
async def test_await_update_200_success_default():
    ...
    response = await client.contacts.batch.update(
...
def test_read_200_success_default():
    """Tests a POST request to the /crm/v3/objects/contacts/batch/read endpoint.
    ...
    response = client.contacts.batch.read(
        inputs=[{"id": "string"}],
        properties=["string"],
...
async def test_await_read_200_success_default():
    ...
    response = await client.contacts.batch.read(
        inputs=[{"id": "string"}],
        properties=["string"],
        properties_with_history=["string"],
    )
...
def test_create_201_success_default():
    """Tests a POST request to the /crm/v3/objects/contacts/batch/create endpoint.
    ...
    response = client.contacts.batch.create(inputs=[{"properties": {}}])
    try:
        pydantic.TypeAdapter(models.BatchResponseSimplePublicObject).validate_python(
            response
        )
...
async def test_await_create_201_success_default():
    ...
    response = await client.contacts.batch.create(inputs=[{"properties": {}}])
    try:
        pydantic.TypeAdapter(models.BatchResponseSimplePublicObject).validate_python(
            response
        )
...
def test_archive_204_success_default():
    """Tests a POST request to the /crm/v3/objects/contacts/batch/archive endpoint.
    ...
    response = client.contacts.batch.archive(inputs=[{"id": "string"}])
...
async def test_await_archive_204_success_default():
    ...
    response = await client.contacts.batch.archive(inputs=[{"id": "string"}])
    assert response is None
