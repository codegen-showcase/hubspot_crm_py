...
def test_search_200_success_default():
    """Tests a POST request to the /crm/v3/objects/meetings/search endpoint.
    ...
    response = client.meetings.search()
    try:
...
async def test_await_search_200_success_default():
    ...
    response = await client.meetings.search()
    try:
        pydantic.TypeAdapter(
            models.CollectionResponseWithTotalSimplePublicObjectForwardPaging
        ).validate_python(response)
...
def test_create_201_success_default():
    ...
    response = client.meetings.create(
        properties={},
        associations=[
            {
                "to": {"id": "101"},
...
async def test_await_create_201_success_default():
    ...
    response = await client.meetings.create(
        properties={},
        associations=[
            {
                "to": {"id": "101"},
...
def test_patch_200_success_default():
    ...
    response = client.meetings.patch(meeting_id="string", properties={})
    try:
        pydantic.TypeAdapter(models.SimplePublicObject).validate_python(response)
        is_json = True
    except pydantic.ValidationError:
...
async def test_await_patch_200_success_default():
    ...
    response = await client.meetings.patch(meeting_id="string", properties={})
    try:
        pydantic.TypeAdapter(models.SimplePublicObject).validate_python(response)
        is_json = True
    except pydantic.ValidationError:
...
def test_get_200_generated_success():
    ...
    response = client.meetings.get(meeting_id="string")
    try:
...
async def test_await_get_200_generated_success():
    ...
    response = await client.meetings.get(meeting_id="string")
    try:
        pydantic.TypeAdapter(models.SimplePublicObjectWithAssociations).validate_python(
            response
        )
...
def test_delete_204_generated_success():
    ...
    response = client.meetings.delete(meeting_id="string")
...
async def test_await_delete_204_generated_success():
    ...
    response = await client.meetings.delete(meeting_id="string")
    assert response is None
